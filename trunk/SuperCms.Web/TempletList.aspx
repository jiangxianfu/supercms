<%@ Page Language="C#" Title="模板管理"  MasterPageFile="~/Sites.Master" AutoEventWireup="true" CodeBehind="TempletList.aspx.cs"   Inherits="SuperCms.Web.TempletList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<asp:Button ID="btnAddNew" runat="server" Text="添加" onclick="btnAddNew_Click" />
    <asp:GridView ID="gvTempletList" runat="server" AutoGenerateColumns="False" BackColor="White"
        BorderColor="#E7E7FF" BorderStyle="Solid" BorderWidth="1px" 
        CellPadding="3" GridLines="Both"
        Width="100%" onrowcommand="gvTempletList_RowCommand">
        <AlternatingRowStyle BackColor="#F7F7F7" />
        <Columns>
            <asp:BoundField HeaderText="模板名称" DataField="Name"/>
            <asp:BoundField HeaderText="文件名" DataField="FileName"/>
            <asp:BoundField HeaderText="所属板块" DataField="Area"/>
            <asp:BoundField HeaderText="模板属性" DataField="TempletAttr"/>
